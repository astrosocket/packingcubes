...
+ We pledge to help the entire community follow the code of conduct, and to
  ...
  contacting josh@joshborrow.com with the subject line *packingcubes Code
...
Any related activity or project organized by members of the packingcubes
...
[swiftsimio CoC](https://github.com/SWIFTSIM/swiftsimio/blob/master/CODE_OF_CONDUCT.md),
which itself adapted parts from the 
